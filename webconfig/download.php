...
$direktori = "../img_anekaweb/download/"; // folder tempat penyimpanan file yang boleh didownload
$filename = $_GET['file'];
...
if ($file_extension=='php'){
  echo "<h1>Access forbidden!</h1>
        ...
        Silahkan hubungi <a href='mailto:aneka_web@yahoo.co.id'>webmaster</a>.</p>";
  exit;
}
else{
