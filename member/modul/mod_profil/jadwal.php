	  ...
	  $cek=mysql_query("SELECT COUNT(*) AS cek FROM pendaftaran 
...
<tr>
  <td colspan='4'> <div class='page-title'>JADWAL</div></td>
  </tr>
...
echo "<td width='200' rowspan='16'><div align='center'><img src='$aneka_web/img_anekaweb/profil/$r[gambar]' width='200' />
      <a href='media.php?module=profil&act=edituser&id=$r[id_pendaftaran]' class='button-blue'>EDIT FOTO</a>
</div></td>";
      }
	  else{
echo "<td width='200' rowspan='16'><div align='center'><img src='$aneka_web/img_anekaweb/profil/no-image.jpg' width='200'/> 
<a href='media.php?module=profil&act=edituser&id=$r[id_pendaftaran]' class='button-green'>EDIT FOTO</a></div></td>";
      }
echo "</tr>
...
echo "</table>
      ...
      case "edituser":
	  $edit=mysql_query("SELECT * FROM pendaftaran WHERE id_pendaftaran=$_SESSION[member_id]");
