...
echo" <script>window.location='index.php'</script>";
	  ...
	  $aksi="pengurus/modul/mod_profil/aksi_calonanggota.php";
	  switch($_GET[act]){
  	  // Tampil User
  	  default:
...
echo "<form action='$aksi?module=anggota&act=hapussemua' method='post'>
	  ...
	  <td> <div class='page-title'>DAFTAR CALON ANGGOTA</div></td>
      <td>
    ...
    if ($_SESSION[pengurus_level]=='pengurus'){
      $tampil = mysql_query("SELECT * FROM pendaftaran WHERE pilihukm='$_SESSION[pengurus_ukm]'
									       and terdaftar='Menunggu Konfirmasi'
...
echo "<tr class=gradeX> 
	  ...
	  <td>$r[tanggal]</td>
      <td>
	  <a href='$aksi?module=anggota&act=hapus&id=$r[id_pendaftaran]' onClick=\"return confirm('Anda yakin calon anggota ini akan dihapus?');\">
	  <b>Tolak</b></span></a> / 
	  <a href='$aksi?module=calonanggota&act=terima&id=$r[id_pendaftaran]' \">
	  <b>Terima</b></span></a>
	  </td> 
      </tr>  
      ";
